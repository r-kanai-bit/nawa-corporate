    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md py-2 transition-all duration-300">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8 flex-1 justify-center">
          <Link href="/" className="text-gray-800 hover:text-[#B8860B] transition-colors duration-300">
            ホーム
          </Link>
          <Link href="/#philosophy" className="text-gray-800 hover:text-[#B8860B] transition-colors duration-300">
            企業理念
          </Link>
          <Link href="/#services" className="text-gray-800 hover:text-[#B8860B] transition-colors duration-300">
            サービス
          </Link>
          <Link href="/#works" className="text-gray-800 hover:text-[#B8860B] transition-colors duration-300">
            施工実績
          </Link>
          <Link href="/#contact" className="text-gray-800 hover:text-[#B8860B] transition-colors duration-300">
            お問い合わせ
          </Link>
        </nav>
