        ...
        <div className="container-custom py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-12">
              <a
                href="/guide"
                className="inline-flex items-center justify-center px-16 py-5 text-xl font-semibold text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 min-w-[320px]"
