          ...
          <div className="overflow-hidden flex-1">
            <div className="flex gap-8 whitespace-nowrap animate-ticker">
              <span className="inline-flex items-center gap-2">
                <span className="text-xs text-accent font-bold">最新</span>
                <span className="text-sm text-dark">Instagramで施工事例・イベント情報を随時更新中！</span>
              </span>
              <span className="inline-flex items-center gap-2">
                <span className="text-xs text-accent font-bold">お知らせ</span>
                <span className="text-sm text-dark">完成見学会・住宅ローン相談会など各種イベント開催中</span>
              </span>
              <span className="inline-flex items-center gap-2">
                <span className="text-xs text-accent font-bold">フォロー</span>
                <span className="text-sm text-dark">@nawainc_since1946 で最新情報をチェック！</span>
              </span>
              <span className="inline-flex items-center gap-2">
                <span className="text-xs text-accent font-bold">最新</span>
                <span className="text-sm text-dark">Instagramで施工事例・イベント情報を随時更新中！</span>
